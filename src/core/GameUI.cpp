...
#include <world/chunk/generation/ChunkGenerator.h>
#include <world/chunk/rendering/RayCaster.h>
#include <world/block/BlocksManager.h>
...
namespace OpenGLSomethingFrameDisplayerEVO
{
    ...
    void Game::RenderUI()
    {
        ...
        ImGui::Separator();
        if (ImGui::BeginCombo("Selected Block",
                              m_state.selectedBlock.blockInfo
                                  ? m_state.selectedBlock.blockInfo->block_name.c_str()
                                  : "None"))
        {
            for (const auto& blockInfo : BlocksManager::GetAllBlockTypes())
            {
                bool isSelected = m_state.selectedBlock.blockInfo && m_state.selectedBlock.blockInfo->block_name ==
