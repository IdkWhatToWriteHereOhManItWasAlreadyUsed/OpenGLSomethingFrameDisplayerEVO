...
namespace OpenGLSomethingFrameDisplayerEVO
{
    ...
    void Game::InitGBuffer()
    {
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB16F, m_state.windowWidth, m_state.windowHeight, 0, GL_RGB, GL_FLOAT,
                     nullptr);
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, m_state.windowWidth, m_state.windowHeight, 0, GL_RGBA, GL_UNSIGNED_BYTE,
                     nullptr);
        glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST);
        glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
        glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);
