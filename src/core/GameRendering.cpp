...
void Game::RenderWorld()
{
    ...
    /*
    не будем использовать фрустум куллинг потому что а зачем мы ж видос пришли смотреть а не камерой вертеть
    */
...
#pragma region Old rendering code. Just for reference
