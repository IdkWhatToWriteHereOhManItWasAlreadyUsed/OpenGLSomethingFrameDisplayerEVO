    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            if (!io.ConfigErrorRecoveryEnableAssert && !io.ConfigErrorRecoveryEnableDebugLog && !io.
                ...
                io.ConfigErrorRecoveryEnableAssert = io.ConfigErrorRecoveryEnableDebugLog = io.
    ...
    if (ImGui::TreeNode("Selection State & Multi-Select"))
    {
        ...
        if (ImGui::TreeNode("Multi-Select (with deletion)"))
        {
                                  ...
                                  ImGuiChildFlags_FrameStyle | ImGuiChildFlags_ResizeY))
            {
                ...
                const bool want_delete = ImGui::Shortcut(ImGuiKey_Delete, ImGuiInputFlags_Repeat) && (selection.Size >
                    0);
        ...
        if (ImGui::TreeNode("Multi-Select (checkboxes)"))
        {
            ...
            static ImGuiMultiSelectFlags flags = ImGuiMultiSelectFlags_NoAutoSelect | ImGuiMultiSelectFlags_NoAutoClear
                                                   ...
                                                   ImGuiSelectionBasicStorage* selection)
                {
                    for (ImGuiSelectionRequest& req : ms_io->Requests)
                    {
                        ...
                        else if (req.Type == ImGuiSelectionRequestType_SetRange)
                        {
                            ...
                            for (ExampleTreeNode* node = first_node; node != NULL; node = TreeGetNextNodeInVisibleOrder(
                                     node, last_node))
...
static void DemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Child windows"))
    {
        ...
        //   the POV of the parent window). See 'Demo->Querying Status (Edited/Active/Hovered etc.)' for details.
        {
            ...
            static ImGuiChildFlags child_flags = ImGuiChildFlags_Borders | ImGuiChildFlags_ResizeX |
                              ...
                              ImGuiWindowFlags_NoMove))
        {
                ...
                ImGui::IsAnyItemActive() == false)
            {
                ...
                if (fabsf(ZoomWheelAccum) >= 1.0f)
                {
                    ...
                    const float hovered_item_nx = (io.MousePos.x - start_pos.x + LayoutItemSpacing * 0.5f) /
                        LayoutItemStep.x;
                    const float hovered_item_ny = (io.MousePos.y - start_pos.y + LayoutItemSpacing * 0.5f) /
                        LayoutItemStep.y;
