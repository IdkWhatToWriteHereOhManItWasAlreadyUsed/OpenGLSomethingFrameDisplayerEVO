...
#include <world/chunk/ChunkInstance.h>
...
namespace OpenGLSomethingFrameDisplayerEVO
{
    ...
    private:
        static void GenerateTerrain(ChunkInstance& chunk, int worldX, int worldZ,
        ...
        static float GetSurfaceHeightAt(int x, int z, std::vector<std::vector<uint8_t>>& heightmap, int mapWidth,
                                        int mapDepth);
